...
urlpatterns = [
    ...
    path('users/<str:username>/followers/', UserFollowersListView.as_view(), name='user-followers-list'),
    path('users/<str:username>/following/', UserFollowingListView.as_view(), name='user-following-list'),
